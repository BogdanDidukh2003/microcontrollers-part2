...
module top ;
	...
	wire [0:0] tmpOE__Button_Encoder_net;
	wire [0:0] tmpFB_0__Button_Encoder_net;
	wire [0:0] tmpIO_0__Button_Encoder_net;
	electrical [0:0] tmpSIOVREF__Button_Encoder_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("199c2740-ff3c-4175-ad4f-a99201ba3df3"),
		  ...
		  .input_buffer_sel(2'b00))
		Button_Encoder
		 (.oe(tmpOE__Button_Encoder_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_Encoder_net[0:0]}),
		  .io({tmpIO_0__Button_Encoder_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_Encoder_net),
		  .interrupt({Net_36}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_Encoder_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
