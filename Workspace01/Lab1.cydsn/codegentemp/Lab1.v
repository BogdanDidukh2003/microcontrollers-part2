...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("88a7369c-e954-4e53-809f-7e3f6c9b5d4d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8cd1007e-fb53-437e-84bf-91c26db75f38"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f40acc78-7c8f-4e1c-9c1e-81e419f31a50"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6fa94a8b-ac51-4154-8073-70f6a0aa38f3"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("9f57ad32-9b9e-4754-aa0a-4b35dbbf1380"),
		  .source_clock_id(""),
		  .divisor(0),
